...
<div class="flex min-h-screen flex-col bg-canvas-soft text-body">
	<div class="border-b border-[#20262d] bg-ink text-white/95">
		<div class="mx-auto flex max-w-[1600px] items-center justify-between gap-3 px-4 py-2.5 md:px-6">
			<div class="relative">
				<button
					type="button"
			...
			<div class="hidden items-center gap-4 text-xs font-semibold text-white/80 md:flex">
				...
				<img src="/vietqr.png" alt="VietQR" class="h-5 w-auto object-contain brightness-0 invert" />
			</div>
		</div>
	</div>
