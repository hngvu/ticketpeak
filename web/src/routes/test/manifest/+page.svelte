<script lang="ts">
	...
	const mockManifestDetailResponse = {
		...
		seats: [
			...
			{
				id: 'M100001-SEC-ORCH-L-row-C-s007',
				rowId: 'M100001-SEC-ORCH-L-row-C',
				name: '007',
				positionX: 317.6363262591834,
				positionY: 297.1668206988229,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-L'
			},
			...
			{
				id: 'M100001-SEC-ORCH-L-row-D-s007',
				rowId: 'M100001-SEC-ORCH-L-row-D',
				name: '007',
				positionX: 333.9498664258431,
				positionY: 289.55969198749034,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-L'
			},
			...
			},
			{
				...
				name: '007',
				positionX: 329.47,
				positionY: 430.21668370009104,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-C'
			},
			{
				id: 'M100001-SEC-ORCH-C-row-D-s008',
				rowId: 'M100001-SEC-ORCH-C-row-D',
				name: '008',
				positionX: 324.59,
				positionY: 449.6715850538315,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-C'
			},
			...
			},
			{
				...
				name: '007',
				positionX: 344.51,
				positionY: 434.44051690850995,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-C'
			},
			{
				id: 'M100001-SEC-ORCH-C-row-E-s008',
				rowId: 'M100001-SEC-ORCH-C-row-E',
				name: '008',
				positionX: 339.22,
				positionY: 455.53181183406036,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-C'
			},
			...
			},
			{
				...
				name: '007',
				positionX: 362.61,
				positionY: 421.2619014651694,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-C'
			},
			{
				id: 'M100001-SEC-ORCH-C-row-F-s008',
				rowId: 'M100001-SEC-ORCH-C-row-F',
				name: '008',
				positionX: 358.94,
				positionY: 441.53832325724824,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-C'
			},
			{
				id: 'M100001-SEC-ORCH-C-row-F-s009',
				rowId: 'M100001-SEC-ORCH-C-row-F',
				name: '009',
				positionX: 353.85,
				positionY: 461.39203861428916,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-C'
			},
			{
				id: 'M100001-SEC-ORCH-C-row-G-s001',
				rowId: 'M100001-SEC-ORCH-C-row-G',
				name: '001',
				positionX: 368.48,
				positionY: 292.74773460548204,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-C'
			},
			{
				id: 'M100001-SEC-ORCH-C-row-G-s002',
				rowId: 'M100001-SEC-ORCH-C-row-G',
				name: '002',
				positionX: 373.94,
				positionY: 314.03091746822986,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-C'
			},
			{
				id: 'M100001-SEC-ORCH-C-row-G-s003',
				rowId: 'M100001-SEC-ORCH-C-row-G',
				name: '003',
				positionX: 377.87,
				positionY: 335.7672416293384,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-C'
			},
			{
				id: 'M100001-SEC-ORCH-C-row-G-s004',
				rowId: 'M100001-SEC-ORCH-C-row-G',
				name: '004',
				positionX: 380.24,
				positionY: 357.8074003867292,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-C'
			},
			{
				id: 'M100001-SEC-ORCH-C-row-G-s005',
				rowId: 'M100001-SEC-ORCH-C-row-G',
				name: '005',
				positionX: 381.03,
				positionY: 380,
			...
			{
				id: 'M100001-SEC-ORCH-C-row-G-s006',
				rowId: 'M100001-SEC-ORCH-C-row-G',
				name: '006',
				positionX: 380.24,
				positionY: 402.1925996132708,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-C'
			},
			{
				id: 'M100001-SEC-ORCH-C-row-G-s007',
				rowId: 'M100001-SEC-ORCH-C-row-G',
				name: '007',
				positionX: 377.87,
				positionY: 424.2327583706616,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-C'
			},
			{
				id: 'M100001-SEC-ORCH-C-row-G-s008',
				rowId: 'M100001-SEC-ORCH-C-row-G',
				name: '008',
				positionX: 373.94,
				positionY: 445.96908253177014,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-C'
			},
			{
				id: 'M100001-SEC-ORCH-C-row-G-s009',
				rowId: 'M100001-SEC-ORCH-C-row-G',
				name: '009',
				positionX: 368.48,
				positionY: 467.25226539451796,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-C'
			},
			...
			{
				id: 'M100001-SEC-ORCH-R-row-C-s007',
				rowId: 'M100001-SEC-ORCH-R-row-C',
				name: '007',
				positionX: 228.9821379489512,
				positionY: 554.6372787409201,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-R'
			},
			...
			{
				id: 'M100001-SEC-ORCH-R-row-D-s007',
				rowId: 'M100001-SEC-ORCH-R-row-D',
				name: '007',
				positionX: 237.15396694426303,
				positionY: 570.6753961763106,
				status: 'AVAILABLE',
				priceLevelId: null,
				sectionId: 'M100001-SEC-ORCH-R'
			},
